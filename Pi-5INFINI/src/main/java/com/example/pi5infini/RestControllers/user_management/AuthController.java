...
import com.example.pi5infini.DAO.Repositories.IRoleRepo;
import com.example.pi5infini.DAO.Repositories.IUserRepo;
import com.example.pi5infini.RestControllers.user_management.request.LoginRequest;
import com.example.pi5infini.RestControllers.user_management.request.SignupRequest;
import com.example.pi5infini.RestControllers.user_management.response.JwtResponse;
import com.example.pi5infini.RestControllers.user_management.response.MessageResponse;
import com.example.pi5infini.Services.user_management.AuthService;
import com.example.pi5infini.Services.user_management.UserDetailsImpl;
import com.example.pi5infini.Services.user_management.exception.BadRequestException;
import com.example.pi5infini.security.JwtUtils;
